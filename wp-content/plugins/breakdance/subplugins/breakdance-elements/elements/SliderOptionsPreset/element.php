...
class Slideroptionspreset extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Slider To Sync",
        [],
        ['type' => 'swiper_input', 'layout' => 'vertical', 'condition' => ['0' => ['0' => ['path' => '%%CURRENTPATH%%.sync_with_another_slider', 'operand' => 'is set', 'value' => '']]]],
        false,
        false,
        [],
      ), c(
        ...
        "Sync Mode",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => ['0' => ['value' => 'thumbs', 'text' => 'Thumbnails'], '1' => ['value' => 'controller', 'text' => 'Controller']], 'condition' => ['0' => ['0' => ['path' => '%%CURRENTPATH%%.sync_with_another_slider', 'operand' => 'is set', 'value' => '']]]],
        false,
        false,
        [],
      ),c(
