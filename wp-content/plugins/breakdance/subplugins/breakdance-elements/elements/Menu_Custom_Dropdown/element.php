...
if (
  ...
  window.breakdanceMenus[menuId].refresh();
    ...
    {
        return ['design.layout.horizontal.vertical_at', 'design.advanced.disable_desktop_styles_at', 'design.layout_v2.layout', 'design.layout_v2.h_vertical_at', 'design.layout_v2.h_alignment_when_vertical', 'design.layout_v2.a_display'];
    }
