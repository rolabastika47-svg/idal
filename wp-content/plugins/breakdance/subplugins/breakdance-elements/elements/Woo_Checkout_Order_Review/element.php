...
\Breakdance\ElementStudio\registerElementForEditing(
    "EssentialElements\\WooCheckoutOrderReview",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class WooCheckoutOrderReview extends \Breakdance\Elements\Element
{
    ...
    {
        return 'bde-checkout-order-review';
    }
...
'onMountedElement' => [['script' => 'jQuery(\'body\').trigger(\'update_checkout\');
',
],],];
    }
