...
class Wooshoppage extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
      ...
      "typography",
       ['type' => 'popout']
        ...
        ['type' => 'section', 'condition' => [[['path' => 'design.facets_integration.disable_pagination', 'operand' => 'is not set', 'value' => '']]]],
        false,
        false,
        [],
      ), getPresetSection(
      ...
      "Pagination",
      "pagination",
       ['condition' => [[['path' => 'design.facets_integration.disable_pagination', 'operand' => 'is not set', 'value' => '']]], 'type' => 'popout']
     ), c(
        "spacing",
        "Spacing",
        [c(
        ...
        "Above Products",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 1, 'max' => 200], 'condition' => [[['path' => 'design.facets_integration.disable_pagination', 'operand' => 'is not set', 'value' => '']]]],
        true,
        false,
        [],
      ), c(
    ...
    {
        return ['design.products_list.elements.image.include', 'design.products_list.elements.title.include', 'design.products_list.elements.price.include', 'design.products_list.elements.rating.include', 'design.products_list.elements.sale_badge.include', 'design.products_list.elements.excerpt.include', 'design.products_list.elements.categories.include', 'design.products_list.elements.button.include', 'design.products_list.elements.quantity_input.include', 'design.products_list.elements.custom_areas.areas', 'design.products_list.elements.image.show_second_image_on_hover'];
    }
}
