...
class FancyDivider extends \Breakdance\Elements\Element
{
    ...
    static function contentControls()
    {
        ...
        "Tag",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => ['0' => ['text' => 'h1', 'value' => 'h1'], '1' => ['text' => 'h2', 'value' => 'h2'], '2' => ['text' => 'h3', 'value' => 'h3'], '3' => ['text' => 'h4', 'value' => 'h4'], '4' => ['text' => 'h5', 'value' => 'h5'], '5' => ['text' => 'h6', 'value' => 'h6']], 'condition' => ['0' => ['0' => ['path' => 'content.divider.content', 'operand' => 'equals', 'value' => 'text']]]],
        false,
        false,
        [],
      )],
