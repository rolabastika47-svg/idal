...
class Basicslider extends \Breakdance\Elements\Element
{
    ...
    {
        return ['content' => ['content' => ['title_html_tag' => 'h3', 'slides' => [['title' => 'Slide 1', 'text' => '<p>The quick, brown, classic rose, and bossanova fox jumped over the lazy dog.</p>', 'background' => ['color' => '#fcbc8f', 'lazy_load' => true], 'button' => null], ['title' => 'Slide 2', 'text' => '<p>The quick, brown, bizarre, and thunderbird fox jumped over the lazy dog.</p>', 'background' => ['color' => '#f0d9db', 'lazy_load' => true]], ['text' => '<p>The quick, brown, charlotte, and red fox jumped over the lazy dog.</p>', 'title' => 'Slide 3', 'background' => ['color' => '#c0faf9', 'lazy_load' => true]]]]], 'design' => ['container' => ['height' => 'custom', 'custom_height' => ['number' => 600, 'unit' => 'px', 'style' => '600px']], 'slide' => ['align_children' => null, 'vertical_align_children' => null], 'slider' => ['arrows' => ['overlay' => true, 'color' => '#000000FF'], 'settings' => null, 'pagination' => ['type' => 'bullets', 'progress_bar' => null, 'margin' => null, 'bullets' => ['color' => '#000000'], 'overlay' => true]], 'spacing' => ['after_text' => null, 'container' => null], 'button' => ['display_as' => null], 'size' => ['height' => 'custom', 'custom_height' => ['breakpoint_base' => ['number' => 500, 'unit' => 'px', 'style' => '500px']]]]];
    }
    ...
    static function contentControls()
    {
      ...
      "button",
       ['type' => 'popout']
        ...
        "Title HTML Tag",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => 'div', 'text' => 'Div'], ['value' => 'p', 'text' => 'P'], ['value' => 'H1', 'text' => 'H1'], ['value' => 'h2', 'text' => 'H2'], ['text' => 'H3', 'value' => 'h3'], ['text' => 'H4', 'value' => 'h4'], ['text' => 'H5', 'value' => 'h5'], ['text' => 'H6', 'value' => 'h6']]],
        false,
        false,
        [],
      )],
...
'onBeforeDeletingElement' => [['script' => 'window.BreakdanceSwiper().destroy(
  \'%%ID%%\'
    ...
    {
        return [['accepts' => 'image_url', 'path' => 'content.content.slides[].background.image'], ['accepts' => 'string', 'path' => 'content.content.slides[].title'], ['accepts' => 'string', 'path' => 'content.content.slides[].text']];
    }
    ...
    {
        return ['design.button.custom.size.full_width_at', 'design.button.style', 'design.container.height', 'design.size.height', 'design.slider.settings.advanced.one_per_view_at', 'design.slider.settings.advanced.slides_per_group', 'design.slider.arrows.overlay', 'design.slider.arrows.disable'];
    }
