...
class CountdownTimer extends \Breakdance\Elements\Element
{
    ...
    {
        return ['0' =>  ['scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%dependencies-files/breakdance-countdown-timer@1/countdown-timer.js'],'builderCondition' => 'return true;','frontendCondition' => 'return true;','title' => 'Breakdance Countdown timer',],'1' =>  ['inlineScripts' => ['new BreakdanceCountdownTimer(\'%%SELECTOR%%\', { content : {{ content|json_encode }}, builder: false });
