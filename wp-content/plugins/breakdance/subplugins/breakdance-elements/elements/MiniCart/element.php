...
class MiniCart extends \Breakdance\Elements\Element
{
    ...
    {
        return ['0' =>  ['scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%dependencies-files/breakdance-mini-cart@1/mini-cart.js'],],'1' =>  ['inlineScripts' => ['new BreakdanceMiniCart(\'%%SELECTOR%%\', 
    {
