...
$buttonClasses = \EssentialElements\getButtonClassesFromDesign(
    $propertiesData,
    'design.form.submit_button.styles_v2',
    'primary',
    'comment-form__submit breakdance-form-button'
);
...
$comment_form_args = array(
    ...
    'class_submit' => $buttonClasses,
    'comment_field' => '<div class="breakdance-form-field breakdance-form-field--textarea"><label class="breakdance-form-field__label" for="comment">' . _x('Comment', 'noun') . '<span class="breakdance-form-field__required">*</span></label><textarea class="breakdance-form-field__input" id="comment" name="comment" aria-required="true"></textarea></div>',
...
if (comments_open($postId)) {
    if (get_post_status($postId) === 'draft' && \Breakdance\isRequestFromBuilderSsr()){
        echo '<div class="breakdance-form-message breakdance-form-message--error comments-form__closed"><p>' . __('Draft posts can\'t have comments', 'breakdance-elements') . '</p></div>';
    }
