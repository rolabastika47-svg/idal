...
class CommentForm extends \Breakdance\Elements\Element
{
    ...
    {
        return ['design.form.submit_button.styles_v2.style', 'design.form.submit_button.styles_v2.custom_type', 'design.form.submit_button.styles_v2.preset'];
    }
}
