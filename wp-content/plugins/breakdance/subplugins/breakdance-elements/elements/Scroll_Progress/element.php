...
class ScrollProgress extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
      ...
      "borders",
       ['type' => 'popout']
        ...
        "Direction",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'left', 'text' => 'Left'], ['text' => 'Right', 'value' => 'right'], ['text' => 'Both', 'value' => 'both']]],
        false,
        false,
        [],
      ...
      "typography",
       ['type' => 'popout']
        ...
        "Align",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'row-reverse', 'text' => 'Left', 'icon' => 'FlexAlignLeftIcon'], ['text' => 'Right', 'value' => 'row', 'icon' => 'FlexAlignRightIcon']], 'buttonBarOptions' => ['size' => 'small'], 'condition' => ['path' => 'content.tracker.type', 'operand' => 'not equals', 'value' => 'circle']],
        true,
        false,
        [],
        ...
        "Offset X",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'condition' => [[['path' => 'design.container.sticky', 'operand' => 'is set', 'value' => '']], [['path' => 'content.tracker.type', 'operand' => 'equals', 'value' => 'circle']]]],
        true,
        false,
        [],
        ...
        "Vertical Align",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'top', 'text' => 'Top', 'icon' => 'FlexAlignTopIcon'], ['text' => 'Center', 'value' => 'center', 'icon' => 'FlexAlignCenterVerticalIcon'], ['text' => 'Bottom', 'value' => 'bottom', 'icon' => 'FlexAlignBottomIcon']], 'condition' => ['path' => 'design.container.sticky', 'operand' => 'is set', 'value' => '']],
        false,
        false,
        [],
        ...
        "Horizontal Align",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'left', 'text' => 'Left', 'icon' => 'FlexAlignLeftIcon'], ['text' => 'Center', 'value' => 'center', 'icon' => 'FlexAlignCenterHorizontalIcon'], ['text' => 'Right', 'value' => 'right', 'icon' => 'FlexAlignRightIcon']], 'buttonBarOptions' => ['size' => 'small'], 'condition' => ['path' => 'design.container.sticky', 'operand' => 'is set', 'value' => '']],
        false,
        false,
        [],
    ...
    static function contentControls()
    {
        ...
        "Type",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'line', 'text' => 'Line'], ['text' => 'Circle', 'value' => 'circle']]],
        false,
        false,
        [],
        ...
        "Track Progress Of",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => 'page', 'text' => 'Page'], ['text' => 'Custom Selector', 'value' => 'custom']]],
        false,
        false,
        [],
        ...
        "Custom Selector",
        [],
        ['type' => 'text', 'layout' => 'inline', 'placeholder' => '#id, .custom_classs', 'condition' => [[['path' => 'content.tracker.track_progress_of', 'operand' => 'equals', 'value' => 'custom']]]],
        false,
        false,
        [],
