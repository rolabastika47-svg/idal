...
class PricingTable extends \Breakdance\Elements\Element
{
    ...
    {
        return ['content' => ['content' => ['title' => 'Breakdance', 'description' => 'Everything you need to succeed.', 'features' => [['text' => 'Use on unlimited websites', 'not_included' => false], ['text' => 'WooCommerce integration', 'not_included' => false], ['text' => 'Design library', 'not_included' => false], ['text' => 'No bloat', 'not_included' => true]], 'icon' => ['slug' => 'icon-pencil', 'name' => 'pencil', 'svgCode' => '<svg xmlns="http://www.w3.org/2000/svg" id="icon-pencil" viewBox="0 0 32 32">
    ...
    static function designControls()
    {
      ...
      "padding",
       ['type' => 'popout']
        ...
        "Border Width",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 0, 'max' => 24, 'step' => 1], 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px']],
        false,
        false,
        [],
      ...
      "typography",
       ['type' => 'popout']
        ...
        "Position",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'after-title', 'text' => 'After Title'], ['text' => 'After Features', 'value' => 'after-features']]],
        false,
        false,
        [],
        ...
        "Period Position",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'vertical', 'text' => 'Vertical'], ['text' => 'Horizontal', 'value' => 'horizontal']]],
        false,
        false,
        [],
        ...
        "Currency Position",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'preprend', 'text' => 'Prepend'], ['text' => 'Append', 'value' => 'append']], 'buttonBarOptions' => ['size' => 'small']],
        false,
        false,
        [],
      ...
      "typography",
       ['type' => 'popout']
        ...
        "Icon Y Nudge",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 1, 'max' => 20, 'step' => 1], 'unitOptions' => ['types' => ['px']]],
        true,
        false,
        [],
    ...
    static function contentControls()
    {
      ...
      "button",
       ['type' => 'popout']
        ...
        "Title",
        [],
        ['type' => 'dropdown', 'layout' => 'vertical', 'items' => [['value' => 'div', 'text' => 'div'], ['value' => 'h1', 'text' => 'h1'], ['value' => 'h2', 'text' => 'h2'], ['value' => 'h3', 'text' => 'h3'], ['value' => 'h4', 'text' => 'h4'], ['value' => 'h5', 'text' => 'h5'], ['value' => 'h6', 'text' => 'h6']]],
        false,
        false,
        [],
        
      )],
        ['type' => 'section', 'layout' => 'vertical', 'sectionOptions' => ['type' => 'popout'], 'disabledInFutureLayer' => true],
        false,
        false,
        [],
