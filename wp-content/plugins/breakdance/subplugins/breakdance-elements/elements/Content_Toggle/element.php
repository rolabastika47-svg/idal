...
class ContentToggle extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Width",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 30, 'max' => 300, 'step' => 1], 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px']],
        true,
        false,
        [],
      ), c(
        ...
        "Height",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 1, 'max' => 80, 'step' => 1]],
        true,
        false,
        [],
      ), c(
        ...
        "Padding",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 0, 'max' => 30, 'step' => 1]],
        true,
        false,
        [],
      ), c(
        ...
        "Radius",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 0, 'max' => 100, 'step' => 1]],
        true,
        false,
        [],
      ), c(
        ...
        "Size",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 5, 'max' => 100, 'step' => 1]],
        true,
        false,
        [],
      ), c(
