...
class Postslist extends \Breakdance\Elements\Element
{
    ...
    static function contentControls()
    {
        ...
        "disable_post_title_as_alt_tag",
        "Disable Post Title As Alt Tag",
        [],
        ...
        "Aria Label",
        [],
        ['type' => 'text', 'layout' => 'vertical', 'placeholder' => 'Read more about %s'],
        false,
        false,
        [],
...
{% endif %}',
    ...
    {
        return ['design.list.one_item_at', 'design.post.image.stack_vertically_at', 'design.list.layout', 'design.post.button.custom.size.full_width_at', 'design.post.button.style', 'design.pagination.load_more_button.custom.size.full_width_at', 'design.pagination.load_more_button.style', 'design.pagination.load_more_button.styles.size.full_width_at', 'design.pagination.load_more_button.styles', 'design.filter_bar.responsive.show_as_dropdown', 'design.filter_bar.horizontal_at', 'design.filter_bar.responsive.visible_at', 'design.pagination.vertical_at', 'design.list.slider.settings.advanced.one_per_view_at', 'design.list.slider.settings.advanced.slides_per_group', 'design.list.slider.arrows.overlay', 'design.list.slider.arrows.disable', 'content.filter_bar.enable', 'design.list.tabs.styles.responsive.show_as_dropdown', 'design.list.tabs.styles.responsive.visible_at', 'design.list.tabs.styles.horizontal_at'];
    }

    static function propertyPathsToSsrElementWhenValueChanges()
    {
        return ['content', 'design.list.layout', 'design.post.button', 'design.filter_bar', 'design.list.accordion.item.style', 'design.list.tabs', 'design.pagination.load_more_button'];
    }
}
