...
class TableOfContents extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Content Alignment",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'left', 'text' => 'Label', 'icon' => 'FlexAlignLeftIcon'], ['icon' => 'FlexAlignRightIcon', 'value' => 'right', 'text' => 'Riht']]],
        false,
        false,
        [],
      ), c(
      ...
      "padding",
       ['type' => 'popout']
        ...
        "Style",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['text' => 'None', 'value' => 'none'], ['text' => 'Bullets', 'value' => 'disc'], ['text' => 'Numbers', 'value' => 'decimal']], 'buttonBarOptions' => ['size' => 'small', 'layout' => 'default']],
        false,
        false,
        [],
      ), c(
    ...
    static function contentControls()
    {
        ...
        "Title Tag",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => 'div', 'text' => 'div'], ['text' => 'h1', 'value' => 'h1'], ['text' => 'h2', 'value' => 'h2'], ['text' => 'h3', 'value' => 'h3'], ['text' => 'h4', 'value' => 'h4'], ['text' => 'h5', 'value' => 'h5'], ['text' => 'h6', 'value' => 'h6']], 'condition' => [[['path' => 'content.content.disable_post_title', 'operand' => 'is not set', 'value' => '']]]],
        false,
        false,
        [],
      ), c(
...
'onBeforeDeletingElement' => [['script' => '(function() {
    ...
    {
        return [['accepts' => 'string', 'path' => 'content.table.title']];
    }
