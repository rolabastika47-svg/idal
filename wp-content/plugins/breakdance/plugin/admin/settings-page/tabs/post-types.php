...
function register()
{
    \Breakdance\Admin\SettingsPage\addTab(esc_html__('Post Types', 'breakdance'), 'post_types', '\Breakdance\Admin\SettingsPage\PostTypesTab\tab', 1199);
}
...
?>
    ...
    <h2><?php esc_html_e('Post Types', 'breakdance'); ?></h2>
    ...
    <form id="post_type_form" action="" method="post">
        ...
        <table class="form-table" role="presentation">
            <tbody>
                <tr>
                    <th scope="row">
                        <?php esc_html_e('Post Types', 'breakdance'); ?>
                    </th>
                    <td>
                        <fieldset>
                            <label for="post_types_all">
                                <input type="checkbox" name="all" value="all" id="post_types_all"> <?php esc_html_e('All Public & Allowed Post Types', 'breakdance'); ?>
                            </label><br />
                            <?php
                        ...
                        <p class="description"><?php
                            ...
                            printf(esc_html__('Editing with %s will only be enabled for the above post types.', 'breakdance'), esc_html(__bdox('plugin_name')));
                        ?></p>
                    </td>
                </tr>
            </tbody>
