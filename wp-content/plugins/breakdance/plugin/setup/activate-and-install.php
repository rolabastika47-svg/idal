...
use function Breakdance\AJAX\delete_all_nonce_updated_transients;
...
function handleVersionChange()
{
    ...
    if (version_compare($last_migrated_version, '2.7.0', '<')) {
        delete_all_nonce_updated_transients();
    }
    ...
    add_action(
        ...
        function ($plugin) {
            ...
            if ($plugin == plugin_basename($pluginFile)) {
                bdox_run_action('breakdance_activated');
            }
        }
    );
