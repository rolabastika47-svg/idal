...
function registerConditionsUserRules()
{
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'label' => __('User Logged In Status', 'breakdance'),
            'category' => __('User', 'breakdance'),
            'operands' => [OPERAND_IS],
            ...
            'values' => function () {
                return [
                    [
                        ...
                        'items' => [
                            ['text' => __('logged in', 'breakdance'), 'value' => 'logged in'],
                            ['text' => __('logged out', 'breakdance'), 'value' => 'logged out']
                        ]
                    ]
                ];
            },
    ...
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'label' => __('User Registration Date', 'breakdance'),
            'category' => __('User', 'breakdance'),
