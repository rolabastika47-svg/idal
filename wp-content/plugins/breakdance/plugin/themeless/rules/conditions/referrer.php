...
function registerConditionsReferrerRules()
{
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'slug' => 'referer_url',
            'label' => __('Referrer URL', 'breakdance'),
            'category' => __('Referrer', 'breakdance'),
    ...
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'availableForType' => ['ALL'],
            'slug' => 'referer_type',
            'label' => __('Referrer Type', 'breakdance'),
            'category' => __('Referrer', 'breakdance'),
            ...
            'values' => function () {
                return [[
                    'label' => __('Referrer Type', 'breakdance'),
                    'items' => [
                        ['text' => __('Search Engine', 'breakdance'), 'value' => 'search_engine'],
                        ['text' => __('Internal', 'breakdance'), 'value' => 'internal'],
                        ['text' => __('External', 'breakdance'), 'value' => 'external'],
                    ]
                ]];
            },
            'callback' => function (string $operand, string $value): bool {
