...
function registerConditionsSingularRules()
{
    ...
    foreach ($postTypes as $postType) {
        ...
        \Breakdance\Themeless\registerCondition(
            [
                ...
                'label' => $postName,
                'category' => __('Singular', 'breakdance'),
        ...
        \Breakdance\Themeless\registerCondition(
            [
                ...
                'label' => sprintf(__('%s Parent', 'breakdance'), $postName),
                'category' => __('Singular', 'breakdance'),
    ...
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'slug' => 'has-taxonomy',
            'label' => __('Has Taxonomy', 'breakdance'),
            'category' => __('Singular', 'breakdance'),
                ...
                function ($operand, $value, $postType) {
                    ...
                    foreach ($value as $encodedTax) {
                        ...
                        if (isset($values['allInTax'])) {
                            ...
                            if ($operand === OPERAND_NONE_OF) {
                                $termQuery['operator'] = 'NOT IN';
                            }

                            $terms_and_taxes[] = $termQuery;
                        } else {
                    ...
                    if ($operand === OPERAND_ONE_OF) {
                        $relation = "OR";
                    } elseif ($operand === OPERAND_NONE_OF || $operand === OPERAND_ALL_OF) {
                        $relation = "AND";
                    } else {
                        return [];
                    }
            ...
            function ($query, $operand, $value) {
                ...
                foreach ($value as $taxonomyData) {
                    ...
                    if (isset($values['allInTax'])) {
                        ...
                        if (!is_wp_error($allTermsInTax)) {
                            ...
                            if ($operand === OPERAND_NONE_OF) {
                                $termTaxQuery['operator'] = 'NOT IN';
                            }

                            $taxQuery[] = $termTaxQuery;
                        }
                    } elseif (isset($values['slug'], $values['name'])) {
                        $termTaxQuery = [
                            'field' => 'slug',
                ...
                if (!empty($taxQuery)) {
                    ...
                    } elseif ($operand === OPERAND_ALL_OF || $operand === OPERAND_NONE_OF) {
    ...
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'availableForType' => $postTypesAndAllSingles,
            'slug' => 'post-status',
            'label' => __('Post Status', 'breakdance'),
            'category' => __('Singular', 'breakdance'),
            'operands' => [OPERAND_IS, OPERAND_IS_NOT],
            'values' => function () {
                return [
                    [
                        'label' => __('Statuses', 'breakdance'),
    ...
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'label' => __('Comments Number', 'breakdance'),
            'category' => __('Singular', 'breakdance'),
            'operands' => [
    ...
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'availableForType' => $postTypesAndAllSingles,
            'slug' => 'post-author',
            'label' => __('Author', 'breakdance'),
            'category' => __('Singular', 'breakdance'),
            'operands' => [OPERAND_IS, OPERAND_IS_NOT],
            'values' => function () {
                return [
                    [
                        'label' => __('Authors', 'breakdance'),
    ...
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'availableForType' => $postTypesAndAllSingles,
            'slug' => 'featured-image',
            'label' => __('Featured Image', 'breakdance'),
            'category' => __('Singular', 'breakdance'),
            'operands' => [OPERAND_IS],
            ...
            'values' => function () {
                return [
                    [
                        ...
                        'items' => [
                            ['text' => __('set', 'breakdance'), 'value' => 'set'],
                            ['text' => __('not set', 'breakdance'), 'value' => 'not set']
                        ]
                    ]
                ];
            },
