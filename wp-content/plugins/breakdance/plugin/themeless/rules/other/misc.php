...
function registerOtherMiscRules()
{
    \Breakdance\Themeless\registerTemplateType(
        ...
        [
            'slug' => '404',
            'label' => __('404 - Not Found Error', 'breakdance'),
            'callback' => function () {
                return is_404();
            },
    ...
    \Breakdance\Themeless\registerTemplateType(
        ...
        [
            'slug' => 'search',
            'label' => __('Search Results', 'breakdance'),
            'callback' =>
            /**
             * @return bool
             */
            ...
            'templatePreviewableItems' => function () {
                return [[
                    'url' => getSearchUrl(),
                    'label' => __("Search", 'breakdance'),
                    'type' => __('search results', 'breakdance'),
                ]];
            },
        ]
    );
        ...
        [
            ...
            'templatePreviewableItems' => function () {
                return [[
                    'url' => getSearchUrl(),
                    'label' => __("Search", 'breakdance'),
                    'type' => __('search archive', 'breakdance'),
                ]];
            }
        ]
    );
    ...
    \Breakdance\Themeless\registerCondition(
        [
            ...
            'label' => __('WP_Query Found Posts Count', 'breakdance'),
            'category' => __('Other', 'breakdance'),
