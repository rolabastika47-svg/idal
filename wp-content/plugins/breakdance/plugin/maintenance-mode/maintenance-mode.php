...
function adminTopBarMenu($admin_bar)
{
    ...
    $admin_bar->add_menu([
        ...
        'title' => '<span class="ab-icon dashicons dashicons-lock"></span> ' . __('Maintenance Mode ON', 'breakdance'),
...
{
    return admin_url('admin.php?page=' . __bdox('admin_page_settings_slug') . '&tab=maintenance-mode');
}
