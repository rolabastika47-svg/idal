...
use Breakdance\Lib\Vendor\Whoops\Util\TemplateHelper;
...
class PrettyPageHandler extends Handler
{
    ...
    public function addDataTableCallback($label, /* callable */ $callback)
    {
        ...
        $this->extraTables[$label] = function (?\Breakdance\Lib\Vendor\Whoops\Inspector\InspectorInterface $inspector = null) use ($callback) {
            try {
