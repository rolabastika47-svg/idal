...
namespace Breakdance\Lib\Vendor\Whoops;
...
final class Run implements RunInterface
{
    ...
    public function register()
    {
        if (!$this->isRegistered) {
            ...
            class_exists("\\Breakdance\Lib\Vendor\Whoops\\Exception\\ErrorException");
    ...
    /**
     * Unregisters all handlers registered by this Breakdance\Lib\Vendor\Whoops\Run instance.
     *
     * @return Run
     */
    ...
    /**
     * Should Breakdance\Lib\Vendor\Whoops allow Handlers to force the script to quit?
     *
     * @param bool|int $exit
     *
     * @return bool
    ...
    /**
     * Should Breakdance\Lib\Vendor\Whoops send HTTP error code to the browser if possible?
     * Breakdance\Lib\Vendor\Whoops will by default send HTTP code 500, but you may wish to
    ...
    /**
     * Should Breakdance\Lib\Vendor\Whoops exit with a specific code on the CLI if possible?
     * Breakdance\Lib\Vendor\Whoops will exit with 1 by default, but you can specify something else.
     *
     * @param int $code
     *
     * @return int
    ...
    /**
     * Should Breakdance\Lib\Vendor\Whoops push output directly to the client?
    ...
    /**
     * Handles an exception, ultimately generating a Breakdance\Lib\Vendor\Whoops error page.
     *
    ...
    private function resolveHandler($handler)
    {
        ...
        if (!$handler instanceof HandlerInterface) {
            throw new InvalidArgumentException(
                ...
                . "Breakdance\Lib\Vendor\Whoops\\Handler\\HandlerInterface"
            );
        }
