 ...
 * instead, which returns an instance of \Breakdance\Lib\Vendor\Twig\TemplateWrapper.
 *
...
abstract class Template
{
    ...
    public function displayBlock($name, array $context, array $blocks = [], $useBlocks = true, self $templateContext = null)
    {
        ...
        if (null !== $template && !$template instanceof self) {
            throw new \LogicException('A block must be a method on a \Breakdance\Lib\Vendor\Twig\Template instance.');
        }
        ...
        if (null !== $template) {
            try {
                ...
                // this is mostly useful for \Breakdance\Lib\Vendor\Twig\Error\LoaderError exceptions
                // see \Breakdance\Lib\Vendor\Twig\Error\LoaderError
