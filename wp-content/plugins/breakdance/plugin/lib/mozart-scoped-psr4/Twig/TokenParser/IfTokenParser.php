...
use Breakdance\Lib\Vendor\Twig\Node\IfNode;
    ...
    public function parse(Token $token): Node
    {
        ...
        while (!$end) {
            switch ($stream->next()->getValue()) {
                ...
                default:
                    throw new SyntaxError(sprintf('Unexpected end of template. Breakdance\Lib\Vendor\Twig was looking for the following tags "else", "elseif", or "endif" to close the "if" block started at line %d).', $lineno), $stream->getCurrent()->getLine(), $stream->getSourceContext());
            }
        }
