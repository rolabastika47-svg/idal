...
use Breakdance\Lib\Vendor\Twig\Node\Expression\ArrayExpression;
use Breakdance\Lib\Vendor\Twig\Node\Expression\ArrowFunctionExpression;
...
use Breakdance\Lib\Vendor\Twig\Node\Expression\BlockReferenceExpression;
use Breakdance\Lib\Vendor\Twig\Node\Expression\ConditionalExpression;
...
use Breakdance\Lib\Vendor\Twig\Node\Expression\ParentExpression;
...
class ExpressionParser
{
    ...
    private function getTestNodeClass(TwigTest $test): string
    {
        if ($test->isDeprecated()) {
            $stream = $this->parser->getStream();
            $message = sprintf('Breakdance\Lib\Vendor\Twig Test "%s" is deprecated', $test->getName());
    ...
    private function getFunctionNodeClass(string $name, int $line): string
    {
        ...
        if ($function->isDeprecated()) {
            $message = sprintf('Breakdance\Lib\Vendor\Twig Function "%s" is deprecated', $function->getName());
    ...
    private function getFilterNodeClass(string $name, int $line): string
    {
        ...
        if ($filter->isDeprecated()) {
            $message = sprintf('Breakdance\Lib\Vendor\Twig Filter "%s" is deprecated', $filter->getName());
