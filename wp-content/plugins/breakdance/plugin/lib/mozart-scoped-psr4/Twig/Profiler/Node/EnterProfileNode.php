...
namespace Breakdance\Lib\Vendor\Twig\Profiler\Node;
...
class EnterProfileNode extends Node
{
    ...
    public function compile(Compiler $compiler): void
    {
        $compiler
            ...
            ->raw("];\n")
            ->write(sprintf('$%s->enter($%s = new \Breakdance\Lib\Vendor\Twig\Profiler\Profile($this->getTemplateName(), ', $this->getAttribute('var_name'), $this->getAttribute('var_name').'_prof'))
