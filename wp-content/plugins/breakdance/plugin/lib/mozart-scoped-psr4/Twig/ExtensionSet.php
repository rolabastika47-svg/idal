...
use Breakdance\Lib\Vendor\Twig\Extension\GlobalsInterface;
use Breakdance\Lib\Vendor\Twig\Extension\StagingExtension;
    ...
    private function initExtension(ExtensionInterface $extension): void
    {
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            if (!$parser instanceof TokenParserInterface) {
                throw new \LogicException('getTokenParsers() must return an array of \Breakdance\Lib\Vendor\Twig\TokenParser\TokenParserInterface.');
            }
