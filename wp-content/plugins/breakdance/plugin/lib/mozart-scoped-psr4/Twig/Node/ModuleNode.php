...
namespace Breakdance\Lib\Vendor\Twig\Node;
...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use Breakdance\Lib\Vendor\Twig\Environment;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Error\LoaderError;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Error\RuntimeError;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Extension\SandboxExtension;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Markup;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Sandbox\SecurityError;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Source;\n")
                ->write("use Breakdance\Lib\Vendor\Twig\Template;\n\n")
            ;
        }
        $compiler
