    ...
    public function compile(Compiler $compiler): void
    {
        ...
        if ($this->hasNode('variables')) {
            ...
            $compiler
                ...
                ->subcompile($node)
                ->raw(";\n")
                ->write(sprintf("if (!\Breakdance\Lib\Vendor\Twig\Extension\Core\Functions\\twig_test_iterable(\$%s)) {\n", $varsName))
                ->indent()
                ...
                ->outdent()
                ->write("}\n")
                ->write(sprintf("\$%s = \Breakdance\Lib\Vendor\Twig\Extension\Core\Functions\\twig_to_array(\$%s);\n", $varsName, $varsName))
            ;
