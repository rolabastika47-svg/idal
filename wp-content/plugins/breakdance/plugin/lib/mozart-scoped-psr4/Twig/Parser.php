...
use Breakdance\Lib\Vendor\Twig\Node\BlockNode;
use Breakdance\Lib\Vendor\Twig\Node\BlockReferenceNode;
...
use Breakdance\Lib\Vendor\Twig\Node\NodeCaptureInterface;
use Breakdance\Lib\Vendor\Twig\Node\NodeOutputInterface;
use Breakdance\Lib\Vendor\Twig\Node\PrintNode;
use Breakdance\Lib\Vendor\Twig\Node\TextNode;
...
class Parser
{
    ...
    private function filterBodyNodes(Node $node, bool $nested = false): ?Node
    {
        ...
        if (
            ...
            throw new SyntaxError('A template that extends another one cannot include content outside Breakdance\Lib\Vendor\Twig blocks. Did you forget to put the content inside a {% block %} tag?', $node->getTemplateLine(), $this->stream->getSourceContext());
        }
