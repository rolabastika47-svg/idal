...
class Consts
{
    ...
    public const BREAKDANCE_FS_ERROR_FILE_DOES_NOT_EXIST = 'BREAKDANCE_FS_ERROR_FILE_DOES_NOT_EXIST';
...
const OXYGEN_UPLOADS_SUBDIR_REL_PATH = 'oxygen';
...
const BREAKDANCE_FS_OPERATION_ERROR_MESSAGES = [
    ...
    Consts::BREAKDANCE_FS_ERROR_FILE_DOES_NOT_EXIST => 'File "%s" does not exist.',
