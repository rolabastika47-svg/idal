<?php
/*
Template Name: Workshop Listing Page
*/
?>
...
?>
        ...
        <section class="media-page-section">
            ...
            <?php
            // Radio option value for workshops
            $post_type_value = 'workshops';
            
            // Get unique years from published workshop posts using custom_date field
            // custom_date format: "19/12/2025 7:05 am" (d/m/Y H:i a)
            $years_args = array(
                'post_type' => 'post',
                'posts_per_page' => -1,
                'post_status' => 'publish',
            ...
            <!-- Filter Dropdowns -->
                ...
                <!-- Workshop Cards Grid -->
                <div class="row g-4" id="workshop-cards-container">
                    <?php
                    ...
                    ?>
                    <div class="col-12">
                        <p><?php echo pll_e("No workshops found."); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
