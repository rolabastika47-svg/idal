<?php
/**
 * Breakdance content controls for Bar Chart element.
 *
 ...
 */
function omsar_bd_bar_chart_default_content_properties() {
	...
	return array(
		...
		'bars'      => array(
			'bars_config' => $defaults['bars_config'],
		),
		'data'      => array(
			'chart_data' => $defaults['chart_data'],
		),
		'bar_style' => array(
			'bar_border_radius' => array( 'number' => 0, 'unit' => 'px' ),
		),
		'legend'    => array(
			'show_legend'      => true,
 ...
 */
function omsar_bd_bar_chart_content_controls() {
					...
					array(
						...
						c(
							...
							array(
								...
								'layout'          => 'vertical',
								'repeaterOptions' => array(
									'titleTemplate'   => 'Value: {bar_value}',
									'defaultTitle'    => 'Value',
									'buttonName'      => 'Add Bar Value',
									'defaultNewValue' => array( 'bar_value' => 0 ),
								),
							),
							false,
							false,
