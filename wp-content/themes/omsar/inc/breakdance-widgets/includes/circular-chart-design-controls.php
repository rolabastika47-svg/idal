<?php
/**
 * Breakdance design controls for Circular Chart element.
 *
 ...
 */
function omsar_bd_circular_chart_design_controls() {
	$align_items = array(
	...
	$donut_condition = array(
		'condition' => array(
			'path'    => 'content.chart.chart_type',
			'operand' => 'equals',
			'value'   => 'doughnut',
		),
	);
