...
class DataTable extends \Breakdance\Elements\Element {
	...
	public static function className() {
		return 'omsar-data-table-element';
	}
	...
	public static function defaultProperties() {
		return array(
			'content' => omsar_bd_data_table_default_content_properties(),
			'design'  => omsar_bd_data_table_default_design_properties(),
		);
	}
	...
	public static function contentControls() {
		return omsar_bd_data_table_content_controls();
	}

	public static function designControls() {
		return omsar_bd_data_table_design_controls();
	}
