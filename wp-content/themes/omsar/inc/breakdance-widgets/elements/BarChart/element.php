...
class BarChart extends \Breakdance\Elements\Element {
	...
	public static function className() {
		return 'omsar-bar-chart-element';
	}
	...
	public static function defaultProperties() {
		return array(
			'content' => omsar_bd_bar_chart_default_content_properties(),
			'design'  => omsar_bd_bar_chart_default_design_properties(),
		);
	}
	...
	public static function contentControls() {
		return omsar_bd_bar_chart_content_controls();
	}

	public static function designControls() {
		return omsar_bd_bar_chart_design_controls();
	}
