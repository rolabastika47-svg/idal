...
class StatisticsCard extends \Breakdance\Elements\Element {
	...
	public static function className() {
		return 'omsar-statistics-card-element';
	}
	...
	public static function defaultProperties() {
		return array(
			'content' => omsar_bd_stat_card_default_content_properties(),
			'design'  => omsar_bd_stat_card_default_design_properties(),
		);
	}
	...
	public static function contentControls() {
		return omsar_bd_stat_card_content_controls();
	}

	public static function designControls() {
		return omsar_bd_stat_card_design_controls();
	}
	...
	public static function dependencies() {
		...
		return array(
			array(
				'title'  => 'OMSAR Statistics Card Theme Styles',
				'styles' => array( $theme . '/assets/css/elementor-style.css' ),
			),
		);
	}
}
